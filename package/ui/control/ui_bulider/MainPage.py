...
class Main_Page(object):
    def __init__(self,Form:QtWidgets.QWidget):
        ...
        self.Single_Input_Count_Internal_Link_checkBox = QtWidgets.QCheckBox(parent=self.Input_Ouput_Setting_Groupbox)
        self.Single_Input_Count_Internal_Link_checkBox.setGeometry(QtCore.QRect(140, 20, 171, 23))
        self.Single_Input_Count_Internal_Link_checkBox.setObjectName("Single_Input_Count_Internal_Link_checkBox")
        ...
        self.Batch_Input_Count_Internal_Link_checkBox = QtWidgets.QCheckBox(parent=self.Input_Ouput_Setting_Groupbox)
        self.Batch_Input_Count_Internal_Link_checkBox.setGeometry(QtCore.QRect(650, 20, 171, 23))
        self.Batch_Input_Count_Internal_Link_checkBox.setObjectName("Batch_Input_Count_Internal_Link_checkBox")
    ...
    def retranslateUi(self, Form:QtWidgets.QWidget):
        ...
        self.Single_Input_Count_Internal_Link_checkBox.setText(_translate("Form", "Count Internal Link"))
        self.Batch_Input_Count_Internal_Link_checkBox.setText(_translate("Form", "Count Internal Link"))
